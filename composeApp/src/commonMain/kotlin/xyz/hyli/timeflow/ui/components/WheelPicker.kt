// https://github.com/miaowmiaow/fragmject/blob/master/app/src/main/java/com/example/fragment/project/components/WheelPicker.kt
...
//                    ) {
                    if (item.offset < pickerCenterLinePx && item.offset + item.size > pickerCenterLinePx) {
