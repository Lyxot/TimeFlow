...
data class Settings(
    ...
    @ProtoNumber(9) val tokens: Tokens? = null,
    @ProtoNumber(10) val apiEndpoint: String? = null,
    @ProtoNumber(11) val cachedUserInfo: User? = null,
    @ProtoNumber(12) val reserved: String? = null,
) {
    companion object {
